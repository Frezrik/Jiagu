...
//void main()
//{
//  char dataIn[] = {0x01, 0x05, 0x17, 0x21, 0x03, 0x05};
//  int outLen;
//  char *encrypt = tiny_aes_encrypt_cbc(dataIn, 6, &outLen);
//  printf("outLen:%d\n", outLen);
//
//  for (int i = 0; i < outLen; i++)
//  {
//    printf("0x%x,", encrypt[i] & 0xff);
//  }
//  printf("\n");
//
//  int deLen;
//  char* decrypt = tiny_aes_decrypt_cbc(encrypt, outLen, &deLen);
//  for (int i = 0; i < deLen; i++)
//  {
//    printf("0x%x,", decrypt[i] & 0xff);
//  }
//
//}