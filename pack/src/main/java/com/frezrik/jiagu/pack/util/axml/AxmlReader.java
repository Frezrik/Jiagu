...
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.END_FILE;
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.END_NS;
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.END_TAG;
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.START_FILE;
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.START_NS;
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.START_TAG;
import static com.frezrik.jiagu.pack.util.axml.AxmlParser.TEXT;
...
public class AxmlReader {
	...
	public String getApplicationName() {
		return mApplicationName == null ? AppManager.PROXY_APPLICATION_NAME : mApplicationName;
	}
